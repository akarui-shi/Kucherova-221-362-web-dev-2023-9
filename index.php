...
<head>
    ...
    <title>Лабораторная работа 9| Кучерова Мария Андреевна | Группа 221-362 | Вариант 12</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <header>
        <h1>Лабораторная работа</h1>
        <p>Кучерова Мария<br>Г221-362<br>Лабораторная работа 9, Вариант 12</p>
    </header>
    <main>
    <?php
